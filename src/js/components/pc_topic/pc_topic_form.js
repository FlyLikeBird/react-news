...
import { PicturesWall } from '../pc_usercenter/pc_usercenter_upload';
...
class TopicForm extends React.Component{
    ...
    _validateFields(isEdit,topicId){
        var { onUpdate, onVisible, form } = this.props;
    ...
    render(){
        var { visible, form, forEdit, onVisible, item } = this.props;
